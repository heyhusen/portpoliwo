<template>
	<header class="py-2">
		<h1 class="font-bold text-2xl sm:text-3xl">Create Portfolio Tag</h1>
	</header>
	...
	<section class="flex flex-col sm:flex-row gap-6 md:gap-8">
		<header class="space-y-1 sm:max-w-2/5">
			...
			<small class="text-sm text-gray-500">
				Add a tag to your portfolio, to make it even more organized than a
				category.
			</small>
		</header>
